...
export const ErrorCreateTxPage = ({
  errorTitle,
  errorDescription,
  setter,
  loader,
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[80vh] mt-6 gap-6 ">
      ...
      <div className="mx-4 mb-8 text-center">
        ...
        <button
          onClick={() => handleCreateNewTX(setter, loader)}
          className="bg-[#1E3A8A] text-white mt-10 px-8 py-4 font-bold rounded-lg hover:bg-[#1E3A8A]/80 transition-colors duration-300 ease-in-out"
        >
          {" "}
